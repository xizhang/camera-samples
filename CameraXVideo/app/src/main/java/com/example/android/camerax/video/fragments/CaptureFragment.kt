...
import com.example.android.camerax.video.effects.BackgroundVideoFrameProcessorListenerExecutor
import com.example.android.camerax.video.effects.CameraFiltersAdapter
import com.example.android.camerax.video.effects.CameraFiltersAdapterProcessor
import com.example.android.camerax.video.effects.SimpleVideoFrameProcessorListener
...
class CaptureFragment : Fragment() {
    ...
    private lateinit var cameraEffect: CameraFiltersAdapter
    ...
    private fun createCameraEffect(): CameraFiltersAdapter? {
        ...
        try {
            // Surface processor handles release of VideoFrameProcessor
            // Camera effect handles release surface processor
            Log.d(TAG, "Create new camera adapter")
            val listenerExecutor = BackgroundVideoFrameProcessorListenerExecutor()
            val cameraFiltersAdapterProcessor =
                CameraFiltersAdapterProcessor(
                    requireContext(),
                    allEffects,
                    ...
                    listenerExecutor,
                    SimpleVideoFrameProcessorListener()
                )
            val cameraEffect =
                CameraFiltersAdapter(
